      ...
      <div className="px-6 py-6">
        {isCompleted && (
          <div className="bg-green-50 border-2 border-green-200 rounded-2xl p-6 mb-6">
            ...
            <button onClick={() => setShowRatingModal(true)} className="w-full bg-[rgb(var(--color-primary))] text-white px-6 py-3 rounded-xl hover:bg-[rgb(var(--color-primary-dark))] transition-colors">
              Avaliar Atendimento
            </button>
          </div>
        )}
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm mb-6">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <button onClick={onOpenChat} className="flex items-center justify-center gap-2 bg-[rgb(var(--color-primary))] text-white px-4 py-3 rounded-xl hover:bg-[rgb(var(--color-primary-dark))] transition-colors">
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm">
          <OrderTimeline currentStatus={activeOrder.currentStatus} statusHistory={activeOrder.statusHistory} />
        </div>
      </div>
    </div>
  );
